...
func ListPageCorpSigning(userId, linkID string, page, pageSize int) (CorporationSigningPageSummary, IModelError) {
	return corpSigningAdapterInstance.ListPage(userId, linkID, page, pageSize)
}
