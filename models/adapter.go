...
func ExportCorpSigningList(userId, linkID string, adminAdded bool, searchQuery string) ([]byte, IModelError) {
	return corpSigningAdapterInstance.ExportCorpSigningList(userId, linkID, adminAdded, searchQuery)
}
