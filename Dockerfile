...
FROM golang:latest
RUN apt-get update && apt-get install -y python3 && apt-get install -y python3-pip && pip3 install git+https://github.com/py-pdf/pypdf.git@3.12.0 --break-system-packages
