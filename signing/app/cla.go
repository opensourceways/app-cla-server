...
type CLAService interface {
	...
	DiffCLALocalFilePath(index domain.CLAIndex, previousClaId string) string
...
func (s *claService) DiffCLALocalFilePath(index domain.CLAIndex, previousClaId string) string {
	return s.cla.DiffCLALocalFilePath(&index, previousClaId)
}
